...
<div class="container">
	<div class="row">
		...
		<!-- restaurant box !-->
		<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-4 restaurant-icons">
			<a href="/restaurants/#Fat-Chicken" class="hvr-float-shadow"><img src="http://www.trinitygroves.com/wp-content/uploads/2017/02/fatchicken.png" class="img-responsive"></a><div class="hidedesktop">Fat Chicken</div>
		</div>
		<!-- restaurant box !-->
		<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-4 restaurant-icons">
		...
		<!-- restaurant box !-->
		<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-4 restaurant-icons">
			<a href="/restaurants/#Souk" class="hvr-float-shadow"><img src="<?php bloginfo('template_url'); ?>/img/restaurants/12.png" class="img-responsive"></a><div class="hidedesktop">Souk</div>
		</div>
		<!-- eof restaurant box !-->
...
<div class="col-lg-12 ">
    ...
    <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15" >
    	<a href="/brewery/"><img src="<?php bloginfo('template_url'); ?>/img/fplogos/1.png" class="img-responsive"></a>
    </div>
    <!-- eof box with content !-->
    
    <!-- box with content !-->
    <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15" >
    	<a href="http://www.trinitygroves.com/neighbor/#3015-at-Trinity-Groves"><img src="<?php bloginfo('template_url'); ?>/img/fplogos/2.png" class="img-responsive"></a>
    </div>
    <!-- eof box with content !-->
    
    <!-- box with content !-->
    <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15" >
    	<a href="/restaurants/#Off-Site Kitchen"><img src="<?php bloginfo('template_url'); ?>/img/fplogos/3.png" class="img-responsive" ></a>
    </div>
    <!-- eof box with content !-->
    ...
    <!-- box with content !-->
    <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15" >
    	<a href="http://www.trinitygroves.com/neighbor/#The-Workroom"><img src="<?php bloginfo('template_url'); ?>/img/fplogos/ec.png" class="img-responsive" ></a>
    </div>
    <!-- eof box with content !-->
